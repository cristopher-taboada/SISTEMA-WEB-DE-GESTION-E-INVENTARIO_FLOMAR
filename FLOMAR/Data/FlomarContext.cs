...
namespace FLOMAR.Data
{
    public class FlomarContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venta>().Property(v => v.id_venta).ValueGeneratedOnAdd();

            modelBuilder.Entity<detalle_venta>().ToTable("DETALLE_VENTA");
            modelBuilder.Entity<detalle_venta>().HasKey(d => d.Id_detalle_venta);
            modelBuilder.Entity<detalle_venta>().Property(d => d.Id_detalle_venta).ValueGeneratedOnAdd();
